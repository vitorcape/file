...
(function($) {
    ...
    $(function() {
      ...
      $img1.attr('src', 'https://imager.radiohabblet.com.br/?user=' + username + '&action=std,crr=&gesture=sml&direction=4&head_direction=3&headonly=true&size=b&img_format=&dance=&effect=&frame_num=30');
